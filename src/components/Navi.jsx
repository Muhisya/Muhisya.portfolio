  ...
  export default function Navbar() {
    ...
    return (
      <nav
        className={`fixed top-0 left-0 w-full bg-gray-800/40 backdrop-blur-md border-b border-gray-700 text-white z-50 transform transition-all duration-700 ease-out ${
          visible ? "translate-y-0 opacity-100" : "-translate-y-10 opacity-0"
        }`}
      >
        <div className="max-w-6xl mx-auto flex items-center justify-between px-6 py-4">
          {/* Logo */}
          <h1 className="text-xl font-bold">Mu<span className="text-[#00D1FF]">hi</span>sya</h1>
        ...
        <motion.div
          ...
          } overflow-hidden md:hidden  bg-gray-800/40 backdrop-blur-md border-b border-gray-700`}
        >
