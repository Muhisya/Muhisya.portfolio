...
const PROJECTS = [
  ...
  },
  {
    id: 4,
    title: "Vantedge",
    description: "High-intensity programs designed for the next generation of digital architects, builders, and creators.",
  ...
  },
  {
    id: 5,
    title: "Ultraman Card",
    description: "A modern search engine built for Ultraman fans to quickly find character info, episode guides, and media content in a sleek, card-based UI.",
    github: "https://github.com/Muhisya/ultraman-card",
    website: "https://ultrasearch.netlify.app/",
    image: "/projects/ultrasearch.png",
    accent: "#2F2FE4",
    tags: ["HTML", "CSS", "JS"],
  },
  {
